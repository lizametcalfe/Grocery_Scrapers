...
class WaitroseSearchSettings(SearchSettings):
	...
	self.next_page_xpath = "//div[@class='load-more-button']/div[@class='view-all-results']//a"
	...
	self.products_xpath = '//*/div[@class="products-row"]//div[contains(@class,"m-product-cell")]/div[contains(@class,"m-product ")]'
	...
	self.promo_xpath = '*/div[@class="m-product-details-container"]//div[contains(@class,"offerDetails")]/a/text()'
	self.offer_xpath = '*/div[@class="m-product-details-container"]//div[contains(@class,"offerDetails")]/a/text()'
